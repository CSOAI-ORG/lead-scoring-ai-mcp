<!-- mcp-name: CSOAI-ORG/lead-scoring-ai-mcp -->
[![MCP Scorecard: 74/100](https://img.shields.io/badge/proofof.ai-74%2F100-5b21b6)](https://proofof.ai/scorecard/lead-scoring-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/lead_scoring_ai_mcp/)

> B2B lead scoring with engagement tracking and prioritization
...
```bash
# Install via pip
pip install lead_scoring_ai_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install lead-scoring-ai-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/lead-scoring-ai-mcp)
